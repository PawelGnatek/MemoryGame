...
function hide2Cards(nr1, nr2) 
{
    ...
    if (pairsLeft == 0) 
    {
        $('.board').html
        (
          '<h1>YOU WIN !!! <br>You Done in: ' +
            turnCounter +
            ' turns.<br> <span class="reload" onclick="restartGame()"> Click To Restart</span></h1>'
        );
    }
